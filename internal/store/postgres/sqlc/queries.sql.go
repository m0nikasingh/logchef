...
type CreateAlertParams struct {
	...
	LookbackSeconds      int32          `json:"lookback_seconds"`
	ThresholdOperator    string         `json:"threshold_operator"`
	ThresholdValue       float64        `json:"threshold_value"`
	FrequencySeconds     int32          `json:"frequency_seconds"`
...
SELECT id, user_id, name, token_hash, prefix, last_used_at, expires_at, created_at, updated_at, scopes FROM api_tokens WHERE id = $1
`
...
SELECT id, user_id, name, token_hash, prefix, last_used_at, expires_at, created_at, updated_at, scopes FROM api_tokens WHERE token_hash = $1
`
...
SELECT id, source_id, name, description, query_type, query, condition_json, lookback_seconds, threshold_operator, threshold_value, frequency_seconds, severity, labels_json, annotations_json, generator_url, is_active, last_state, last_evaluated_at, last_triggered_at, created_at, updated_at, recipient_user_ids_json, webhook_urls_json, created_by FROM alerts WHERE id = $1
`
...
SELECT id, source_id, name, description, query_type, query_content, created_at, updated_at, created_by, created_from_team_id FROM saved_queries WHERE id = $1
`
...
SELECT id, name, _meta_is_auto_created, _meta_ts_field, _meta_severity_field, host, username, password, database, table_name, description, ttl_days, created_at, updated_at, managed, secret_ref, tls_enable FROM sources WHERE id = $1
`
...
SELECT id, name, _meta_is_auto_created, _meta_ts_field, _meta_severity_field, host, username, password, database, table_name, description, ttl_days, created_at, updated_at, managed, secret_ref, tls_enable FROM sources WHERE database = $1 AND table_name = $2
`
...
SELECT id, name, _meta_is_auto_created, _meta_ts_field, _meta_severity_field, host, username, password, database, table_name, description, ttl_days, created_at, updated_at, managed, secret_ref, tls_enable FROM sources WHERE name = $1
`
...
SELECT id, name, description, created_at, updated_at, managed FROM teams WHERE id = $1
`
...
SELECT id, name, description, created_at, updated_at, managed FROM teams WHERE name = $1
`
...
SELECT id, email, full_name, role, status, last_login_at, last_active_at, created_at, updated_at, managed, account_type FROM users WHERE id = $1
`
...
SELECT id, email, full_name, role, status, last_login_at, last_active_at, created_at, updated_at, managed, account_type FROM users WHERE email = $1
`
...
SELECT id, user_id, name, token_hash, prefix, last_used_at, expires_at, created_at, updated_at, scopes FROM api_tokens WHERE user_id = $1 ORDER BY created_at DESC
`
...
SELECT id, source_id, name, description, query_type, query, condition_json, lookback_seconds, threshold_operator, threshold_value, frequency_seconds, severity, labels_json, annotations_json, generator_url, is_active, last_state, last_evaluated_at, last_triggered_at, created_at, updated_at, recipient_user_ids_json, webhook_urls_json, created_by FROM alerts
...
SELECT id, name, _meta_is_auto_created, _meta_ts_field, _meta_severity_field, host, username, password, database, table_name, description, ttl_days, created_at, updated_at, managed, secret_ref, tls_enable FROM sources WHERE managed = TRUE ORDER BY id
`
...
SELECT id, name, description, created_at, updated_at, managed FROM teams WHERE managed = TRUE ORDER BY id
`
...
SELECT id, email, full_name, role, status, last_login_at, last_active_at, created_at, updated_at, managed, account_type FROM users WHERE managed = TRUE ORDER BY id
`
...
func (q *Queries) PruneAlertHistory(ctx context.Context, arg PruneAlertHistoryParams) error {
	_, err := q.exec(ctx, q.pruneAlertHistoryStmt, pruneAlertHistory, arg.AlertID, arg.AlertID_2, arg.Keep)
	return err
}
