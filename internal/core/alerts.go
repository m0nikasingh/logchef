...
func validateRecipientUserIDs(ctx context.Context, db store.Store, recipientIDs []models.UserID) error {
...
func CreateAlert(ctx context.Context, db store.Store, log *slog.Logger, sourceID models.SourceID, createdBy models.UserID, req *models.CreateAlertRequest) (*models.Alert, error) {
	if req == nil {
...
func GetAlert(ctx context.Context, db store.Store, log *slog.Logger, alertID models.AlertID) (*models.Alert, error) {
...
func UpdateAlert(ctx context.Context, db store.Store, log *slog.Logger, alertID models.AlertID, req *models.UpdateAlertRequest) (*models.Alert, error) {
	if req == nil {
		return nil, ErrInvalidAlertConfiguration
	}
...
func DeleteAlert(ctx context.Context, db store.Store, log *slog.Logger, alertID models.AlertID) error {
...
func ListAlertsBySource(ctx context.Context, db store.Store, sourceID models.SourceID) ([]*models.Alert, error) {
...
func ListAlertsForUser(ctx context.Context, db store.Store, userID models.UserID) ([]*models.Alert, error) {
...
func ListAlertHistory(ctx context.Context, db store.Store, alertID models.AlertID, limit int) ([]*models.AlertHistoryEntry, error) {
...
func ResolveAlert(ctx context.Context, db store.Store, log *slog.Logger, alertID models.AlertID, message string) error {
...
func TestAlertQuery(ctx context.Context, db store.Store, ch *clickhouse.Manager, log *slog.Logger, sourceID models.SourceID, req *models.TestAlertQueryRequest) (*models.TestAlertQueryResponse, error) {
	if req == nil {
