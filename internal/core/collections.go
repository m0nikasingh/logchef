...
func EnsurePersonalCollection(ctx context.Context, db store.Store, log *slog.Logger, user *models.User) (*models.Collection, error) {
	if user == nil {
...
func ListCollectionsForUser(ctx context.Context, db store.Store, log *slog.Logger, user *models.User) ([]*models.Collection, error) {
...
func CreateCollection(ctx context.Context, db store.Store, log *slog.Logger, name, description string, createdBy models.UserID) (*models.Collection, error) {
...
func GetCollectionForUser(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, userID models.UserID) (*models.Collection, models.CollectionRole, error) {
	collection, err := db.GetCollection(ctx, collectionID)
	if err != nil {
		if errors.Is(err, sql.ErrNoRows) || store.IsNotFoundError(err) {
...
func UpdateCollection(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, userID models.UserID, name, description string) (*models.Collection, error) {
...
func DeleteCollection(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, userID models.UserID) error {
	collection, role, err := GetCollectionForUser(ctx, db, log, collectionID, userID)
	if err != nil {
		return err
	}
...
func AddCollectionMember(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID, targetUserID models.UserID, role models.CollectionRole) error {
...
func RemoveCollectionMember(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID, targetUserID models.UserID) error {
	collection, callerRole, err := GetCollectionForUser(ctx, db, log, collectionID, callerID)
	if err != nil {
		return err
	}
...
func ListCollectionMembers(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID) ([]*models.CollectionMember, error) {
...
func AddCollectionItem(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID, savedQueryID, sortOrder int) error {
...
func RemoveCollectionItem(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID, savedQueryID int) error {
	_, callerRole, err := GetCollectionForUser(ctx, db, log, collectionID, callerID)
	if err != nil {
		return err
	}
...
func ListCollectionItems(ctx context.Context, db store.Store, log *slog.Logger, collectionID int, callerID models.UserID) ([]*models.CollectionItem, error) {
	if _, _, err := GetCollectionForUser(ctx, db, log, collectionID, callerID); err != nil {
		return nil, err
	}
